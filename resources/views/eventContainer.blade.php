    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content mod text-center modal-dialog">
        ...
        <div class="modal-footer text-center">
          <button type="button" class="btn btn-default start-btn" data-dismiss="modal">Close</button>
          <a href="{{ url('/register') }}"><button type="button" class="btn btn-default start-btn" data-dismiss="modal">Sign-Up</button></a>
        </div>
      </div>
