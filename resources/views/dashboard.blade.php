 ...
 <!-- <section class="content-header"> -->
    <div class="container">
      ...
      <div class="row">
          ...
          <ul class="breadcrumb col-md-12" style="background-color: inherit; font-size: 15px">
    ...
    <!-- start of add parent name     -->
      <div class="row" style="margin-bottom: 20px">
          <div class="col-md-6 col-md-offset-2"  style="background-color: #fff; box-shadow: 3px 3px 1px #ccc">
              ...
              <div class="form-group">
          <button class="btn btn-primary col-md-4 col-md-offset-4" style="margin-bottom: 10px">Add the Parent Name</button>  
      ...
      <div class="row" style="margin-bottom: 20px">
          ...
          <div class="col-md-6 col-md-offset-2"  style="background-color: #fff; box-shadow: 3px 3px 1px #ccc">
            ...
            <div class="form-group">
                <label class="control-label col-md-4" style="text-align: left">Category Name</label>
                <div class="col-md-8">
          ...
          <div class="form-group">
          <button class="btn btn-primary col-md-4 col-md-offset-4" style="margin-bottom: 10px">Add the Sub Category Name</button>  
  ...
  <div class="row" style="margin-bottom: 20px">
          <div class="col-md-6 col-md-offset-2"  style="background-color: #fff; box-shadow: 3px 3px 1px #ccc">
              <h3><strong>Delete Parent</strong></h3>
               ...
               <div class="form-group">
          <button class="btn btn-primary col-md-4 col-md-offset-4" style="margin-bottom: 10px">Delete the Parent Name</button>  
  ...
  <div class="row" style="margin-bottom: 20px">
          <div class="col-md-6 col-md-offset-2"  style="background-color: #fff; box-shadow: 3px 3px 1px #ccc">
              <h3><strong>Delete Child</strong></h3>
               ...
               <div class="form-group">
          <button class="btn btn-primary col-md-4 col-md-offset-4" style="margin-bottom: 10px">Delete the Child Name</button>  
